...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            b5.setBounds(580, 620, 159, 41);
            contentPane.add(b5);

            JPanel panel = new JPanel();
            panel.setBorder(new TitledBorder(new LineBorder(new Color(250, 128, 114), 10), "Operation", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(220, 20, 60)));
            panel.setBounds(20, 120, 940, 560);
