...
public class AddBook extends JFrame implements ActionListener{
	...
	t6.setColumns(10);
	t6.setBounds(300, 350, 250,40);
	contentPane.add(t6);

	comboBox = new JComboBox();
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "1", "2", "3", "4", "5", "6", "7", "8", "9" }));
	comboBox.setFont(new Font("Trebuchet MS", Font.BOLD, 35));
        comboBox.setBounds(300, 250, 250, 40);
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(138, 43, 226), 6), "Add Books", TitledBorder.LEADING,
			TitledBorder.TOP, null, new Color(0, 0, 255)));
	panel.setBounds(5,10, 590, 600);
